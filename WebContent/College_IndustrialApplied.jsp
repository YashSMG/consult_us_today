...
<body style="background-color: #f1f1f1;">
                                               ...
                                               <%--   <td><%=	bean.getCmpy_image() %></td> --%>  
                                                ...
                                                <td>
                                        			<a href='viewIndustrialVisit.jsp?id=<%= bean.getIndustrial_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-success btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                         			...
                                         			<button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-warning btn-sm" name="tid"  onclick="getTId(<%=bean.getCmpy_image()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    			</td>
   ...
   <nav aria-label="Page navigation example">
  <ul class="pagination justify-content-end" style="margin-left: 900px; margin-top: -45px">
    ...
    <script>
    	function changeJobSts(val){
    	  ...
    	  $.ajax({
    		...
    		url:"IndustrialPostin_ApprovalStatus.jsp",
