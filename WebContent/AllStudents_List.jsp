                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                           ...
                           <!--  <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        List<Student_Bean> list = Student_Dao.getAllStudentRecord();
                                        
                                        for(Student_Bean bean:list){
                                        
                                        %>
                                            <tr>
                                               	<td>
                            						<img src="<%=request.getContextPath()%><%=bean.getImage()%>" style="width:70px; height:70px">
                            					</td>
                                                <td><%= bean.getName() %></td>
                            					...
                            					<td>
                                        			<a href='viewStudent.jsp?id=<%= bean.getStd_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-info btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        			</a>                                      
                                         			...
                                         			<button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-danger btn-sm" name="tid"  onclick="getTId(<%=bean.getStd_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    			</td>
                      ...
                      <%
                       ...
                       <td>
                       <label class="switch">                                                                      
                       <input type="checkbox" name="uid"   onclick="changeJobSts(<%=bean.getStd_id()%>)">         
                     ...
                     <td>
                       <label class="switch">                                                                    
                       <input type="checkbox" name="uid"   checked onclick="changeJobSts(<%=bean.getStd_id()%>)">                                               
                       <span class="slider round" ></span>
                       </label>                   
                     </td>
                    <%
                    ...
                    <!-- priority status -->
					 <%
                        String priorityStatus = bean.getStud_priority();
                        if(priorityStatus.equals("Unpaid")){
                     %>
                       <td>
                       <label class="switch">                                                                      
                       <input type="checkbox" name="uid" onclick="changePriority(<%=bean.getStd_id()%>)">         
                       <span class="slider round" ></span>
                       </label>                   
                     </td>
                     <% 
                     ...
                     <td>
                       <label class="switch">                                                                    
                       <input type="checkbox" name="uid" checked onclick="changePriority(<%=bean.getStd_id()%>)">                                               
                       <span class="slider round" ></span>
                       </label>                   
                     </td>
                    <%
					...
					<!-- priority status -->
                                ...
                                <!-- 
                                <div class="fixed-table-pagination" style="margin-top: -70px; margin-right: 60px">
                                <div class="pull-left pagination-detail">
                                    <span class="pagination-info">Showing 1 to 10 of 25 rows</span>
                                   <span class="page-list">
                                   <span class="btn-group dgroup">
