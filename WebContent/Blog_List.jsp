                        ...
                        <div style="background-color: white" class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                  ...
                                  <!--    <button style="text-align: right ;margin-left: 800px;">
                                        <a href="Blogs.jsp">Add Blogs</a>
                                    </button>
                                    -->
                                </div>
                            ...
                            <div class="sparkline13-graph">
                                ...
                                <div class="container">
							      ...
							      <a href="Blogs.jsp" class=" btn-lg"> <span class="glyphicon glyphicon-user" style="margin-left: 1100px; margin-bottom: -100px; size: 200px"></span>   
							     </a>
                             <table id="table" data-toggle="table" data-pagination="false" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>   
                                                <th data-field="Company Name">Posted By</th>
                                                <th data-field="Contact">Title</th>
                                        ...
                                        %>
                                            <tr>
                                                ...
                                                <td>
                                        <a href='viewBlog.jsp?id=<%= bean.getBlogid() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-success btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        </a>
                                      ...
                                      <%--  <a href="EditTransaction.jsp?tid=<%=bean.getClg_id()%>" data-toggle="modal" data-target="#myModalharsha" data-uid="1" class="update btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span>
                                         ...
                                         <button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-warning btn-sm" name="tid"  onclick="getTId(<%=bean.getBlogid()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    </td>
