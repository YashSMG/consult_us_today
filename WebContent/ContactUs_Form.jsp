                ...
                <div class="row" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width: 107%;">
                        <div class="sparkline12-list">
                            ...
                            <div class="col-md-8" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);  margin-top: 100px; margin-left: 280px; margin-right:20px;">
                                    ...
                                    <div class="row" >
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                             <div class="all-form-element-inner">
                                                ...
                                                <center>
                                                <form action="contactus.jsp" method="post" style="margin-left: 370px;">

                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <label class="row" style="margin-left: -106px;"> Name:</label>
                                                              
                                                                <input id="name" name="name" type="text" class="form-control" style="border-radius: 15px;width: 400px;margin-left: -110px;" />
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                 <label class="" style="margin-left: -106px;">Email:</label>
                                                                 <input id="email" type="text" name="email"class="form-control" style="border-radius: 15px;width:400px;margin-left: -110px;"/>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                 <label class="" style="margin-left: -106px;">Message:</label>
                                                                 <textarea id="description" name="message"class="form-control" style="border-radius: 15px;width:400px;margin-left: -110px;"></textarea>
