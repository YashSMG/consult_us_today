...
<body>
                ...
                <div class="row" style="margin-right: -150px" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width: 107%;">
                        <div class="sparkline12-list" style="margin-top: -50px">
                            ...
                            <div id="formcolor" style="background-color: #ffffff;">
                                 ...
                                 <div style="padding-top: 25px;">
                                           <center><h1><b>Notice Board </b></h1></center>
                                 </div>
                                    ...
                                    <div class="row" >
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                             <div class="all-form-element-inner">
                                                ...
                                                <center><form action="NoticeBoardApply_form.jsp" method="post" style="margin-left: 370px;">

                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <label class="row" style="margin-left: -106px;"> Suject of Notice:</label>
                                                                <input name="subject" type="text" class="form-control" style="border-radius: 15px;width: 400px;margin-left: -100px;">
                                                   ...
                                                   <!--  <div class="form-group-inner">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                 <label class="" style="margin-left: -106px;">Notice Description:</label>
                                                                 <textarea id="description" name="notice_description"class="form-control" style="border-radius: 15px;width:400px;margin-left: -110px;"></textarea>
                                                               <div id="description" style="color:red; height:0.1px; font-size:12px;"></div>
                                                            </div>
                                                     ...
                                                     <div class="form-group-inner">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                 <label class="" style="margin-left: -106px;"> Start Date:</label>
                                                               
                                                                <input name="start_date" type="date" class="form-control" style="border-radius: 15px;width: 400px;margin-left: -100px;">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <input name="end_date" type="date" class="form-control" style="border-radius: 15px;width: 400px;margin-left: -100px;">
                                                                 <div id="edate" style="height: 0.1px;"></div>
                                                            </div>
