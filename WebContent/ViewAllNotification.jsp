                             ...
                             <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>   
                                                ...
                                                <th data-field="Contact">Message</th>
                                       ...
                                       <%
                                   		...
                                   		if(session.getAttribute("usertype").equals("Company")){
                                   			...
                                   			List<Notification_Bean> list = Notification_Dao.viewCompN(uid);
                                   				for(Notification_Bean bean : list){
                                   
                                        %>
                                            <tr>
                                                <td><%=bean.getTitle() %></td>
                                                <td><%=bean.getMassege() %></td>
                                      ...
                                      <% 
                                			...
                                			List<Notification_Bean> list = Notification_Dao.viewStdN(uid);
                                      			for(Notification_Bean bean: list){
