                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="registration link">Registration Link</th>
                                                <th data-field="posted date">Posted Date</th>
                                                <th data-field="position">Position</th>
                                                <th data-field="drive info">Drive Info</th>                                
                                        ...
                                        %>
                                            ...
                                            <tr>                                                
                                                ...
                                                <td><%=bean.getApproval_status() %></td>
                                             	<td>
                                        			<a href='viewJob.jsp?id=<%= bean.getCampus_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-success btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        			</a>                                     
