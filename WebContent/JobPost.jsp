                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Job Title" data-editable="true">Job Title</th>
                                                <th data-field="Technology" data-editable="true">Technology</th>
                                               <th data-field="Vacancy" data-editable="true">Vacancy</th>
                                               <th data-field="Other" data-editable="true">Other</th>
                                                <th>Action</th>
                                        ...
                                        %>
                                            ...
                                            <tr>                                                
                                             ...
                                             <td>
                                        <a href='viewJob.jsp?id=<%= bean.getPosting_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-success btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        </a>
                                      ...
                                      <%--  <a href="EditTransaction.jsp?tid=<%=bean.getClg_id()%>" data-toggle="modal" data-target="#myModalharsha" data-uid="1" class="update btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span>
                                         ...
                                         <button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-warning btn-sm" name="tid"  onclick="getTId(<%=bean.getPosting_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    </td>
