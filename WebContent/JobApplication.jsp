                                ...
                                <div class="main-sparkline13-hd">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name" data-editable="true">CURRENT LOCATION</th>
                                                <th data-field="email" data-editable="true">PAST EXPERIENCE</th>
                                    ...
                                    //   int id = (Integer) obj;
                                        ...
                                        %>
                                            ...
                                            <tr>
                                                <td><%=bean.getName() %></td>                                               
                                                <td><%= bean.getCurrent_location() %></td>
                                                <td><%= bean.getPastexperience() %></td>
                                                <td><%= bean.getDescription() %></td>                                               
                                            	<td>
                                        			<a href='viewJobAppln.jsp?id=<%= bean.getJob_appln_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-success btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        			</a>
                                         			...
                                         			<button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-warning btn-sm" name="tid"  onclick="getTId(<%=bean.getJob_appln_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    			</td>
                                            	<!-- status code starts -->
    <td>
        ...
        <ul class="dropdown-menu" style="position: relative;">
    	  ...
    	  <div id="Status" class="modal fade" role="dialog">
		   ...
		   <div id="delete" class="modal fade" role="dialog">
			  <div class="modal-dialog">
			    <div class="modal-content">
			    <form action="DeleteJobApplication.jsp">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal">×</button>
