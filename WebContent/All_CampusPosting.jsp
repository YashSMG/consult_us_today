            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                       ...
                                       %>
                                            <tr>
                                               <td >
                                                ...
                                                <td>
                                        			<a href='viewCampus.jsp?id=<%= bean.getCampus_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-info btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        			</a>
                                         			...
                                         			<button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-danger btn-sm" name="tid"  onclick="getTId(<%=bean.getCampus_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    			</td>
                        <%
                       ...
                       <td>
                       <label class="switch">                                                                      
                       <input type="checkbox" name="uid"  onclick="changeJobSts(<%=bean.getCampus_id()%>)">         
                     ...
                     <td>
                       <label class="switch">                                                                    
                       <input type="checkbox" name="uid"  checked onclick="changeJobSts(<%=bean.getCampus_id()%>)">                                               
                       <span class="slider round" ></span>
                       </label>                   
                     </td>
                    <%
    ...
    <script>
    	function changeJobSts(val){
    	  ...
    	  $.ajax({
    		...
    		url:"CampusPosting_ApprovalStatus.jsp",
