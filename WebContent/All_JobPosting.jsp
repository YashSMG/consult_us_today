...
<body style="background-image: #f1f1f1">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list" style="background-color: white">
                           <!--  <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1 style="text-align: left;">Job Posts</h1>
                                </div>
                            </div> -->
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Job Title">Job Title</th>
                                                <th>Action</th>
                                                <th>Approve</th>
                                            </tr>
                                        ...
                                        <%
                                        List<JobPost_Bean>list=JobPost_Dao.viewAllJobPosting();
                                        ...
                                        %>
                                            ...
                                            <tr>                                                
                                                ...
                                                <td><%=bean.getName() %></td>
                                                <td><%= bean.getJob_title() %></td>
                                             	<td>
                                        			<a href='viewJob.jsp?id=<%= bean.getPosting_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-info btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        			</a>                                     
                                         			...
                                         			<button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-danger btn-sm" name="tid"  onclick="getTId(<%=bean.getPosting_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    			</td>
                                            
                       <%
                        String applnStatus = bean.getApproval_satus();
                        if(applnStatus.equals("NotApproved")){
                        %>
                       <td>
                       <label class="switch">                                                                      
                       <input type="checkbox" name="uid"  onclick="changeJobSts(<%=bean.getPosting_id()%>)">         
                     ...
                     <td>
                       <label class="switch">                                                                    
                       <input type="checkbox" name="uid"  checked onclick="changeJobSts(<%=bean.getPosting_id()%>)">                                               
                       <span class="slider round" ></span>
                       </label>                   
                     </td>
                    <%
...
<script>
    	function changeJobSts(val){
    	  ...
    	  $.ajax({
    		...
    		url:"JobPosting_ApprovalStatus.jsp",
