                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list" style="background-color: white" >
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        List<Industrial_Bean> list = Industrial_Dao.allIndustrialApplns();                                        
                                        for(Industrial_Bean bean : list){
                                        %>
                                            
                                            <tr>
                                                <td><img src="<%=request.getContextPath()%><%=bean.getCmpy_image() %>" style="width:70px ; height:70px; text-align: center;"></td>                                               
                                                <td><%= bean.getName() %></td>
                                                <%-- <td><%= bean.get %></td> --%>
                                                <td><%= bean.getApplied_date() %></td>
                                                <td><%= bean.getApproval_status() %></td>                                               
                                            	<td>
                                        			<a href='viewJobAppln.jsp?id=<%= bean.getIndustrial_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-info btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        			</a>
    ...
    <script>
    	function changeJobSts(val){
    	  ...
    	  $.ajax({
    		...
    		url:"IndustrialAppln_ApprovalStatus.jsp",
