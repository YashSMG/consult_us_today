                        ...
                        <div class="sparkline13-list" style="background-color: white">
                            <!-- <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1 style="text-align: left;"><span class="table-project-n">Industrial List</span> </h1>
                                </div>
                            </div> -->
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name" data-editable="true">TRAININGINFO</th>
                                                <th data-field="email" data-editable="true">VISIT DATE</th>
                                       ...
                                       // int comid = (Integer) company;
                                        ...
                                        %>
                                          <tr>
                                                ...
                                                <td><%= bean.getVisit_date() %></td>
                                                <td> <%=bean.getPosted_date() %></td>
                                        		<td>
                                        			<a href='viewIndustrialVisit.jsp?id=<%= bean.getIndustrial_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-success btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        			</a>
                                         			...
                                         			<button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-warning btn-sm" name="tid"  onclick="getTId(<%=bean.getIndustrial_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    			</td>
                                            	<!-- status code starts -->
    <td>
      ...
      <div class="dropdown pull-right" id="maxrows" style="margin-left: 30px;">
        ...
        <ul class="dropdown-menu" style="position: relative;">
            <li><a tabindex="-1" href="#" data-toggle="modal"  data-target="#Status" 
                onclick="getData(<%= bean.getIndustrial_id() %>,'Waiting')">Waiting</a>
            </li>
            <li><a tabindex="-1" href=# data-toggle="modal" data-target="#Status" 
                onclick="getData(<%= bean.getIndustrial_id() %>,'Shortlisted')">Shortlist</a>
            </li>
            <li><a tabindex="-1" href="#" data-toggle="modal" data-target="#Status" 
                onclick="getData(<%= bean.getIndustrial_id() %>,'Rejected')">Reject</a>
            </li> 
        </ul>
      </div>
      </div>
    	...
    	<div id="Status" class="modal fade" role="dialog">
			  <div class="modal-dialog">
			    ...
			    <form action="IndustrialApplication_Status.jsp">
