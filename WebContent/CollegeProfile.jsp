...
<body>
        ...
        <div class="row" style="margin-top: -10px">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width: 107%">
                        <div class="sparkline12-list" style="margin-left: 100px">
                            ...
                            <div id="formcolor" style="background-color: #ffffff;">
                                 ...
                                 <div style="padding-top: 25px;">
                                           <center><h1><b>College Profile  </b></h1></center>
                                 </div>
                                ...
                                <div class="basic-login-form-ad" style="text-align: center;">
                                    ...
                                    <div class="row">
                                      ...
                                      <!--  <center>
                                         ...
                                         <td><td><td><td>
                                          <input name="clg_img_ori" type="hidden" value="<%=bean.getImage()%>">
                                       ...
                                       <!--  <input readonly= "readonly"  id="pic" name="comp_img" class='pis' onchange="readURL(this);" type="file" style=" padding-bottom: 17px; margin-left: 104px;">  -->
								                           ...
								                           <tr>
                                                           <td> <label style="margin-bottom: 20px; margin-top: -120px;">College Name</label></td>
                                                           <td> <input readonly="readonly" name="name" type="text" class="form-control" placeholder="College  Name" value="<%= bean.getName() %>"  style=" margin-bottom: 20px; width: 350px; margin-left: 50px; margin-top: -127px;"></td>
                                                        </tr>
                                                          
                                                       
                                                       
                                                            <tr>
                                                            <td> <label style="margin-bottom: 20px;margin-top: -70px;" >Mou No</label ></td>
                                                           <td> <td><input readonly="readonly" name="mou_no" class="form-control" placeholder="Mou No" value="<%= bean.getMou_no() %>" style="width: 200%; margin-bottom: 20px; width: 350px; margin-top: -75px;margin-left: -350px;"></td></td>
                                                            </tr>
                                                        
                                                           <tr>
                                                           <td><label style="margin-bottom: 20px; margin-top: -20px; ">Contact No</label></td>
                                                          <td> <td> <input readonly=" readonly"   name="contact_no"  class="form-control" placeholder="Contact_no" value="<%= bean.getContact_no() %>" style="margin-bottom: 20px; margin-left: -350px; width: 350px; margin-top: -25px"></td></td>
                                                            </tr>
                                                        

                                                           <tr>
                                                           <td><label style="margin-bottom: 20px;">Email</label></td>
                                                          <td> <td> <input readonly="readonly" type="text" name="email" class="form-control" placeholder="Email" value="<%= bean.getEmail()%>" style=" margin-bottom: 20px; margin-left: -350px; width: 350px;"> </td></td>
                                                           </tr>
                                                    ...
                                                    <div class="row">
														<div class="col-lg-12">
															<div class="payment-adress mg-t-15"
																...
																<a href="Update_College_Profile.jsp"><input type="button" name="Update"
