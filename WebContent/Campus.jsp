...
<head>
    ...
    <title>Campus | Kiaalap - Kiaalap Admin Template</title>
                        ...
                        <div style="background-color: white;" class="sparkline13-list">
                            <!-- <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1 style="text-align: left;">Campus List</h1>
                                </div>
                            </div> -->
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                               ...
                                               <!--  <th data-field="Email" data-editable="true">Email</th> -->
                                                <th data-field="Posted Date" data-editable="true">Posted Date</th>
                                                <th data-field="Registration Link" data-editable="true">Registration Link</th>
                                                <th data-field="Position" data-editable="true">Position</th>
                                                <th data-field="Drive Info" data-editable="true">Drive Info</th>
                                        ...
                                        %>
                                            <tr>
                                               ...
                                               <td >
                                                ...
                                                <td><%= bean.getRegistration_link() %></td>
                                                <td><%= bean.getPosition() %></td>
                                                <td><%= bean.getDrive_info() %></td>
                                                <td><a href="CampusApply_form.jsp?id=<%=bean.getCampus_id()%>"><input type="button" name="Apply" value="Apply"></a></td>
                                                <td>
                                        <a href='viewCampus.jsp?id=<%= bean.getCampus_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-success btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        </a>
                                      ...
                                      <%--  <a href="EditTransaction.jsp?tid=<%=bean.getClg_id()%>" data-toggle="modal" data-target="#myModalharsha" data-uid="1" class="update btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span>
                                         ...
                                         <button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-warning btn-sm" name="tid"  onclick="getTId(<%=bean.getCampus_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    </td>
                                            </tr>
