...
<body style="background-color: #f1f1f1;"> 
        ...
        <!-- Static Table Start -->
        <div style="margin-top: -60px; margin-left:-40px;"  id="boxshadow" class="tableshadow" ><!-- style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); margin-left: 275px; margin-right: 20px; margin-top: 70px;" -->
                           ...
                           <!--  <div class="sparkline13-hd">
                            ...
                            <div class="sparkline13-graph" >
                             ...
                             <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        List<Company_Bean> list=Company_Dao.getCompanyRecord();
                                        ...
                                        %>
                                            <tr>
                                                ...
                                                <td>
                                        <a href='viewCompany.jsp?id=<%= bean.getComp_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-success btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        </a>
                                      ...
                                      <%--  <a href="EditTransaction.jsp?tid=<%=bean.getClg_id()%>" data-toggle="modal" data-target="#myModalharsha" data-uid="1" class="update btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span>
                                         ...
                                         <button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-warning btn-sm" name="tid"  onclick="getTId(<%=bean.getComp_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    </td>
