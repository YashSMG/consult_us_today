                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="job title">Training Info</th>
                                                <th data-field="technology">Posted Date</th>
                                                <th data-field="posted date">Visit Date</th>                                
                                        ...
                                        %>
                                            ...
                                            <tr>                                                
                                                ...
                                                <td><%=bean.getApproval_status() %></td>
                                             	<td>
                                        			<a href='viewJob.jsp?id=<%= bean.getIndustrial_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-success btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        			</a>                                     
