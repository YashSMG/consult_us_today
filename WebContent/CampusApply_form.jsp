...
<body>
        ...
        <div class="single-pro-review-area mt-t-30 mg-b-15">
            ...
            <div class="container-fluid" style="margin-top: -50px">
                ...
                <% 
                   String campus_id = request.getParameter("id");
                int id = Integer.parseInt(campus_id);
                
                Object obj = session.getAttribute("id");
                int clgid = (Integer)obj;
                
                Campus_Bean b=Campus_Dao.viewCampus(id);

                %> 
                    
                    
                        <form action="CampusApply.jsp" id="loginForm">
                            <div class="row">
                            <div class="form-group col-lg-6" style="width: 50%;margin-bottom: 15px; margin-left: 110px">
                                    <label>Company Name</label>
                                    <input name="college_id" value="<%= clgid%>" type="hidden">
                                    <input name="campus_id" value="<%=b.getCampus_id()%>" type="hidden">
                                    <input name="comp_id" value="<%=b.getComp_id()%>" type="hidden">
                                    <input name="job_title" class="form-control"  value="<%=b.getName() %>"><br>
                                    
                                    <label>Position</label>
                                    <input name="position" class="form-control" value="<%= b.getPosition()%>"><br>
                                    
                                    
                                     <label>Drive_info</label>
                                    <input name="drive_info" class="form-control" value="<%=b.getDrive_info()%>"><br><br>
