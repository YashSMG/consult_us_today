<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.company.bean.JobApplication_Bean" %>
    <%@ page import="com.company.dao.JobApplication_Dao" %>
                        ...
                        <div class="sparkline13-list" style="background-color: white">
                            <!-- <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1 style="text-align: left;"><span class="table-project-n">Job Applications</span> </h1>
                                </div>
                            </div> -->
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="email" >Applied For</th>
                                        ...
                                        List<JobApplication_Bean> list = JobApplication_Dao.viewAllJobAppln();                                        
                                        for(JobApplication_Bean bean : list){
                                        %>
                                            
                                            <tr>
                                                <td><img src="<%=request.getContextPath()%><%=bean.getImage() %>" style="width:70px ; height:70px"></td>                                               
                                                <td><%= bean.getName() %></td>
                                                <td><%= bean.getComp_name() %></td>
                                                <td><%= bean.getApplied_for() %></td>
                                                <td><%= bean.getApproval_status() %></td>                                               
                                            	<td>
                                        			<a href='viewJobAppln.jsp?id=<%= bean.getJob_appln_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-info btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        			</a>
                                         			...
                                         			<button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-danger btn-sm" name="tid"  onclick="getTId(<%=bean.getJob_appln_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    			</td>
                                            	<!-- status code starts -->
    <td>
      <div class="dropdown pull-right" id="maxrows" style="margin-right: 10px;">
        ...
        <ul class="dropdown-menu" style="position: relative;">
            <li><a tabindex="-1" href="#" data-toggle="modal"  data-target="#Status" 
                    onclick="getData(<%= bean.getJob_appln_id() %>,'Waiting')">Waiting</a>
            </li>
            <li><a tabindex="-1" href=# data-toggle="modal" data-target="#Status" 
                onclick="getData(<%= bean.getJob_appln_id() %>,'Shortlisted')">Shortlist</a>
            </li>
            <li><a tabindex="-1" href="#" data-toggle="modal" data-target="#Status" 
                onclick="getData(<%= bean.getJob_appln_id() %>,'Rejected')">Reject</a>
            </li> 
        </ul>
      </div>
    </td>
                       ...
                       <td>
                       <label class="switch">                                                                      
                       <input type="checkbox" name="uid"  value="<%=bean.getJob_appln_id()%>" onclick="changeJobSts(<%=bean.getJob_appln_id()%>)">         
                     ...
                     <td>
                       <label class="switch">                                                                    
                       <input type="checkbox" name="uid"  value="<%=bean.getJob_appln_id()%>"  checked onclick="changeJobSts(<%=bean.getJob_appln_id()%>)">                                               
                       <span class="slider round" ></span>
                       </label>                   
                     </td>
                    <%
    ...
    <script>
    	function changeJobSts(val){
    	  ...
    	  $.ajax({
    		...
    		url:"JobAppln_ApprovalStatus.jsp",
