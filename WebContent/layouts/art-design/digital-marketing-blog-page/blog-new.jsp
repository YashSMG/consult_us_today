...
</script><title>CunsultUsToday Blog | Cyberathon</title>

<meta name="robots" content="noindex,follow" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="CunsultUsToday Blog | Cyberathon" />
...
<!-- <link href="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
 ...
 <link rel="stylesheet" type="text/css" href="../../../wayup/slideronlinecss.css">
 ...
 <script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  ...
  <!-- slider css link -->
       <link rel="stylesheet" type="text/css" href="../../../wayup/slidernew.css"> 
  <!-- slider css link -->
  <!-- wayup script starts -->
...
<!-- <div id="page-container"> -->
 ...
 <nav class="navbar navbar-fixed-top navbar-transparent top" ><!-- style="margin-top: -40px;" -->
        <div class="container">
            <div class="navbar-header">
              <a class="navbar-brand logo" href="#">
                  
                  <img id="logo" class="white-logo" src="../../wp-content/uploads/2018/05/LOGO.png" 
                        ><!-- style="height: 155px;width: 280px; margin-top:6px;
                               margin-bottom: 22px;margin-left: 119px;margin-right: 10px;" -->
                  </a>
            </div>
          <div class="collapse navbar-collapse" id="navbar">
            
        <ul class="et_pb_member_social_links et_pb_module et_pb_social_media_follow     
         et_pb_social_media_follow_0 clearfix et_pb_bg_layout_light et_pb_text_align_center ulscr" 
          style="display: flex;font-size: 16px;font-family: 
          initial;padding-left: 15px;margin-top: 4px;"> <!-- margin-bottom: 90px; -->
    
      <li style="padding-right: 0px; color: #001871;">Helpline no. 108</li>
      ...
      <ul id="top-menu" class="nav">
        ...
        <li id="menu-item-213056" class="menu-item menu-item-type-post_type  
                menu-item-object-page menu-item-213056">
          <a href="../../art-design/digital-marketing-home-page/home.jsp">Home</a>
        </li>

        <li id="menu-item-213054" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-213054">
          <a href="../../art-design/digital-marketing-about-page/about_new.jsp">About</a>
        </li>

        <li id="menu-item-213046" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-213046">
          <a href="../../art-design/digital-marketing-services-page/services.jsp">Services</a>
        </li>

        <li id="menu-item-213050" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-213050">
          <a href="../../art-design/digital-marketing-careers-page/careers.jsp">Careers</a>
        </li>

        <li id="menu-item-213042" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-213041 current_page_item menu-item-213042">
            <a href="blog.jsp" aria-current="page" class="navbar-btn btn btn-inverse btn--sign-up">Blog</a>
        </li>

        <li id="menu-item-213044" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-213044">
          <a href="../../art-design/digital-marketing-contact-page/contact.jsp">Contact</a>
        </li>
...
<div class="et_pb_text_inner"><h3 style="margin-top: 120px;">BLog</h3>
<h1>Want to Learn About Marketing?</h1></div>
</div> 
</div> 
              ...
              <div id="blogCarousel" 
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    ...
                    <%
						List<Blog_Bean> list = Blog_Dao.getBlogASC();
	
						for(Blog_Bean bean :list){
                      ...
                      <div class="col-md-4" >
                        <div class="item-box-blog">
                          <div class="item-box-blog-image">
                            ...
                            <span class="mon"><%=bean.getPublished() %></span> 
                            </div>
                            <!--Image-->
                            <figure> <img alt="" src="<%=request.getContextPath()%><%=bean.getImage()%>" 
                            		style="height:190px;"> </figure>
                          </div>
                          <div class="item-box-blog-body">
                            ...
                            <div class="item-box-blog-data" style="padding: px 15px;">
                              <p><i class="fa fa-user-o"></i> <%=bean.getPosted_by() %>, <i class="fa fa-comments-o"></i> Comments(3)</p>
                            </div>
                            <!--Text-->
                 ...
                 <div class="carousel-item ">
                    <div class="row">
                       ...
                       <%
						List<Blog_Bean> list1 = Blog_Dao.getBlogDESC();
	
						for(Blog_Bean bean1 :list1){
                      ...
                      <div class="col-md-4" >
                        <div class="item-box-blog">
                          <div class="item-box-blog-image">
                            ...
                            <div class="item-box-blog-date bg-blue-ui white"> <span class="mon"><%=bean1.getPublished() %></span> </div>
                           
                            <figure> <img alt="" src="<%=request.getContextPath()%><%=bean1.getImage()%>" 
                            					 style="height:190px;"> </figure>
                          </div>
                          <div class="item-box-blog-body">
                            ...
                            <div class="item-box-blog-heading">
                              <a href="#" tabindex="0">
                                <h5><%=bean1.getTitle() %></h5>
                              </a>
                            </div>
                           
                            <div class="item-box-blog-data" style="padding: px 15px;">
                              <p><i class="fa fa-user-o"></i> <%=bean1.getPosted_by() %>, <i class="fa fa-comments-o"></i> Comments(3)</p>
                            </div>
                           
                            <div class="item-box-blog-text">
                              <p><%=bean1.getDescription() %></p>
                            </div>
                            <div class="mt"> <a href="#" tabindex="0" class="btn bg-blue-ui white read">read more</a> </div>
