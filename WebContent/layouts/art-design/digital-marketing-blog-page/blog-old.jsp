...
<link rel="stylesheet" id="et-core-unified-cached-inline-styles" href="../../wp-content/cache/et/213041/et-core-unified-15730742407299.min.css" onerror="et_core_page_resource_fallback(this, true)" onload="et_core_page_resource_fallback(this)" /></head>
...
<article id="post-4800" class="et_pb_post clearfix post-4800 post type-post status-publish 
								format-standard has-post-thumbnail hentry category-category">
<div class="et_pb_image_container">
	<a href="#" class="entry-featured-image-url">
		<img src="<%=request.getContextPath() %><%=bean.getImage() %>" alt="Nunc Volutpat Venenatis" 
						class="" srcset="" sizes="(max-width:479px) 479w, 100vw " width='400' height='250' />
	</a>
</div> 
<h4 class="entry-title"><a href="#"><%=bean.getTitle() %></a></h4>
<p class="post-meta">by 
			<span class="author vcard">
			     <a href="#" title="Posts by Nick Roach" rel="author"><%=bean.getPosted_by() %></a>
			</span> | <span class="published"><%=bean.getPublished() %></span> | 
