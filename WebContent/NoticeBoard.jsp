<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.company.dao.Notification_Dao" %>
...
<body style="background-color: #f1f1f1;">
        ...
        <div style="margin-top: -60px" id="boxshadow" class="tableheader">
            <span>
                <h3>Notice Board</h3>
            </span>
        </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Subject of Notice">Subject of Notice</th>
                                                <th data-field="Notice Date" data-editable="true">Start Date</th>
                                                  <th data-field="Notice Description" data-editable="true">Notice Description</th>
                           
                                                <th data-field="End Date" data-editable="true">End Date</th>
                                                             <th data-field="Apply">Apply</th>
                                              <th>Action</th>  
                                        ...
                                        List<NoticeBoard_Bean> list=NoticeBoard_Dao.getNoticeRecord();
                                        
                                        for(NoticeBoard_Bean bean:list){
                                        ...
                                        %>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="NoticeBoard_form.jsp?id=<%=bean.getNotice_id()%>"><input type="button" name="Apply" value="Apply"></a></td>
                                                <td>
                                        <a href='ViewNotice.jsp?id=<%= bean.getNotice_id()%>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-success btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        </a>
                                      ...
                                      <%--  <a href="EditTransaction.jsp?tid=<%=bean.getClg_id()%>" data-toggle="modal" data-target="#myModalharsha" data-uid="1" class="update btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span>
                                         ...
                                         <button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-warning btn-sm" name="tid"  onclick="getTId(<%=bean.getNotice_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    </td>
