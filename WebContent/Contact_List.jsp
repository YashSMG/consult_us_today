                        ...
                        <div class="sparkline13-list" style="background-color: white">
                            <!-- <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1 style="text-align: left;">ContactUs Detailes</h1>
                                </div>
                            </div> -->
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Student Name">Name</th>
                                                <th data-field="Contact" data-editable="true">Email</th>
                                                <th data-field="email" data-editable="true">Message</th>
                                        ...
                                        List<Contact_Bean>list=Contact_Dao.getContacusDetails();
                                        
                                        for(Contact_Bean bean:list){
                                        ...
                                        %>
                                            <tr>
                                                ...
                                                <td><%=bean.getcDate() %></td>
                            		 <td>
                                        <a href='viewContact.jsp?id=<%= bean.getContact_id() %>' data-toggle="modal" data-target="#myinfo" data-uid="1" class="update btn btn-info btn-sm"><span class="glyphicon glyphicon-eye-open"></span>
                                        </a>
                                      ...
                                      <%--  <a href="EditTransaction.jsp?tid=<%=bean.getClg_id()%>" data-toggle="modal" data-target="#myModalharsha" data-uid="1" class="update btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span>
                                         ...
                                         <button type="button" data-toggle="modal" data-target="#delete" data-uid="1" class="delete btn btn-danger btn-sm" name="tid"  onclick="getTId(<%=bean.getContact_id()%>)"><span class="glyphicon glyphicon-trash"></span></button>  
                                    </td>
                                            </tr>
